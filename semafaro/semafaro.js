...
// uma variavel (var) manipula dados vindos do html por meio de indentificadores.
//uma constante(const)manipula elementos vindos do html por meido de classe(quaryselector).
